	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<p class="lead">Create New Visual for 'Agri-Agra Bonds'</p>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<spring:form method="POST" modelAttribute="agriAgraBonds">
							...
							<label>Total Agri-Agra Bonds</label>
							<div>
								<spring:input path="total" class="span3" placeholder="(e.g. 150000)" constraint="number" />
							</div>
							
							<label>Amount Issued</label>
							<div>
								<spring:input path="amount" class="span3" placeholder="(e.g. 200000)" constraint="number" />
							</div>
