	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<p class="lead">Create New Visual for 'Bonds Issued'</p>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<spring:form method="POST" modelAttribute="bondsIssued">
							...
							<label>Amount</label>
							<div>
								<spring:input path="amount" class="span3" placeholder="(e.g. 175000)" constraint="number" />
							</div>
