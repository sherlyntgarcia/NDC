	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<p class="lead">Create New Visual for 'Principal & Coupon Payments'</p>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<spring:form method="POST" modelAttribute="pcPayments">
							...
							<div>
								<spring:input path="bondIssued" class="span3" placeholder="(e.g. 200000)" constraint="number" />
							</div>
							
							<label>Coupon</label>
							<div>
								<spring:input path="coupon" class="span3" placeholder="(e.g. 300000)" constraint="number" />
							</div>
							
							<label>Bond Payment</label>
							<div>
								<spring:input path="bondPayment" class="span3" placeholder="(e.g. 500000)" constraint="number" />
							</div>
							
							<label>Coupon Payment</label>
							<div>
								<spring:input path="couponPayment" class="span3" placeholder="(e.g. 750000)" constraint="number" />
							</div>
