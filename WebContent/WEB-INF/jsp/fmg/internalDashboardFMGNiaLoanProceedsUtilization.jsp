	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<p class="lead">Create New Visual for 'NIA Loan Proceeds (Utilization)'</p>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<spring:form method="POST" modelAttribute="niaLoanProceedsUtilization">
							...
							<label>Repair, Rehabilitation and Restoration</label>
							<div>
								<spring:input path="repairRehabRestore" class="span4" placeholder="(e.g. 250000)" constraint="number" />
							</div>
							
							<label>Rehabilitation of Farm-to-market roads</label>
							<div>
								<spring:input path="farmToMarketRoads" class="span4" placeholder="(e.g. 275000)" constraint="number" />
							</div>
