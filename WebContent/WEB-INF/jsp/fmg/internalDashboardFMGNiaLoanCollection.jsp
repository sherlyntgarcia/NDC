	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<p class="lead">Create New Visual for 'NIA Loan (Collection)'</p>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<spring:form method="POST" modelAttribute="niaLoanCollection">
							...
							<label>Principal (Loan Receivable)</label>
							<div>
								<spring:input path="principalLoanReceivable" class="span3" placeholder="(e.g. 500000)" constraint="number" />
							</div>
							
							<label>Principal (Collection)</label>
							<div>
								<spring:input path="principalCollection" class="span3" placeholder="(e.g. 400000)" constraint="number" />
							</div>
							
							<label>Interest (Loan Receivable)</label>
							<div>
								<spring:input path="interestLoanReceivable" class="span3" placeholder="(e.g. 450000)" constraint="number" />
							</div>
							
							<label>Interest (Collection)</label>
							<div>
								<spring:input path="interestCollection" class="span3" placeholder="(e.g. 125000)" constraint="number" />
							</div>
