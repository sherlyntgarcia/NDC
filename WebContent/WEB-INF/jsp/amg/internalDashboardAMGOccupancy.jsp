	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="span12">
						<p class="lead">Create New Visual for 'Occupancy'</p>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<spring:form modelAttribute="occupancy" method="POST">
							...
							<label>No. of Occupied</label>
							<div>
								<spring:input path="occupied" class="span3" constraint="number" placeholder="(e.g. 20)" />
							</div>
							
							<label>No. of Vacant</label>
							<div>
								<spring:input path="vacant" class="span3" constraint="number" placeholder="(e.g. 30)" />
							</div>
