							...
							<div class="span12">
								<div class="span5">
									<div style="margin-top: 20px">
										...
										<ul class="unstyled">
											<li>
												<img onclick="window.location.href='${pageContext.request.contextPath}/dashboard/internal/AMG/luzon'" style="width:100px;height:70px" src="${pageContext.request.contextPath}/resources/img/luzon_legend.png" />
												- <span style="font-weight: bold">Luzon</span></li>
											<li>
												<img onclick="window.location.href='${pageContext.request.contextPath}/dashboard/internal/AMG/visayas'" style="width:100px;height:70px" src="${pageContext.request.contextPath}/resources/img/visayas_legend.png" />
												- <span style="font-weight: bold">Visayas</span></li>
											<li>
												<img onclick="window.location.href='${pageContext.request.contextPath}/dashboard/internal/AMG/mindanao'" style="width:100px;height:70px" src="${pageContext.request.contextPath}/resources/img/mindanao_legend.png" />
								...
								<div class="span7">
									...
									<map name="pinas">
										<area shape="poly"
											...
											href="<c:url value = "/dashboard/internal/AMG/luzon"/>" alt="" title="Luzon" />
										<area shape="poly"
											...
											href="<c:url value = "/dashboard/internal/AMG/visayas"/>" alt=""
											title="Visayas" />
										<area shape="poly"
											...
											href="<c:url value = "/dashboard/internal/AMG/mindanao"/>" alt=""
											title="Mindanao" />
