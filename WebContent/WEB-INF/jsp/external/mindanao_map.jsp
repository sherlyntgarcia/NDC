...
<%-- 				<div id="davao" title="Toril, Davao City" class="fixed"><a href="#" class="pin"><img src="${pageContext.request.contextPath}/resources/img/pins/dev.png" /></a></div> --%>
				...
				<div id="macasandigcagayandeoro" title="Bgy. Macasandig, Cagayan De Oro City" class="fixed"><a href="#" class="pin"><img src="${pageContext.request.contextPath}/resources/img/pins/dev.png" /></a></div>
				<div id="iponancagayandeoro" title="Bgy. Iponan, Cagayan De Oro City" class="fixed"><a href="#" class="pin"><img src="${pageContext.request.contextPath}/resources/img/pins/dev.png" /></a></div>
			</div> <!-- /container -->
