					...
					<div class = "span8">				
						...
						<div class="tab-content">
						  <div class="tab-pane active" id="description" style = "margin-left: 5%">
						  		<ul>
						  			<li>A national program in the development and installation of mini-hydropower plants in existing and planned irrigation systems. Rationale to pursue the project:</li>
						  			<ul>
