		...
		<div class="row-fluid" style="margin-top:10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="span12">
						<p class="lead">
							Create New Visual for 'Balance Sheet'
						</p>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<spring:form modelAttribute="balanceSheet" method="POST">
							...
							<div>
								<spring:input path="totalAssets" class="span3" constraint="number" placeholder="(e.g. 300000)" />
							</div>
							
							<label>Total Liabilities</label>
							<div>
								<spring:input path="totalLiabilities" class="span3" constraint="number" placeholder="(e.g. 200000)" />
							</div>
