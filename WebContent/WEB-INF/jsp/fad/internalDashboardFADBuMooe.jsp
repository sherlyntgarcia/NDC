	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top: 10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="span12">
						<p class="lead">Create New Visual for 'Budget Utilization (Maintenance & Other Operating Expenses)'</p>
				...
				<spring:form modelAttribute="buMooe" method="POST">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<label>Budget (Maintenance & Other Operating Expenses)</label>
							<div>
								<spring:input path="budgetMooe" class="span3"
									constraint="number" placeholder="(e.g. 1500000)" />
							</div>
							
							<label>Actual (Maintenance & Other Operating Expenses)</label>
							<div>
								<spring:input path="actualMooe" class="span3"
									constraint="number" placeholder="(e.g. 2000000)" />
							</div>
