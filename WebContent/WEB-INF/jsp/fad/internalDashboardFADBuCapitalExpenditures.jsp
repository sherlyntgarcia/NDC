	...
	<div class="row-fluid">
		...
		<div class="row-fluid" style="margin-top: 10px">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="span12">
						<p class="lead">Create New Visual for 'Budget Utilization (Capital Expenditures)'</p>
				...
				<spring:form modelAttribute="buCapitalExpenditures" method="POST">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<label>Budget (Capital Expenditures)</label>
							<div>
								<spring:input path="budgetCapitalExpenditures" class="span3"
									constraint="number" placeholder="(e.g. 700000)" />
							</div>
							
							<label>Actual (Capital Expenditures)</label>
							<div>
								<spring:input path="actualCapitalExpenditures" class="span3"
									constraint="number" placeholder="(e.g. 1000000)" />
							</div>
