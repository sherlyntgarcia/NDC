					...
					<div style="width:1000px;padding:10px;margin:0 auto;margin-top:20px">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="amgTactical">
								...
								<div class="row-fluid">
									<div class="span6">
										<img alt="Occupancy is not available" src="${pageContext.request.contextPath}/visualization/occupancypiechart/450/400" />
									</div>
									
									<div class="span6">
										<img alt="Maintenance Cost is not available" src="${pageContext.request.contextPath}/visualization/maintenancecostlinechart/450/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span6">
										<img alt="Sources Funds is not available" src="${pageContext.request.contextPath}/visualization/sourcesfundsbarchart/450/400" />
									</div>
									
									<div class="span6">
										<img alt="Status Assets is not available" src="${pageContext.request.contextPath}/visualization/statusassetsbarchart/450/400" />
									</div>
								</div>
							...
							<div class="tab-pane" id="fmgTactical">
								...
								<div class="row-fluid">
									<div class="span6">
										<img alt="Bonds Issued is not available" src="${pageContext.request.contextPath}/visualization/bondsissuedbarchart/450/400" />
									</div>
									
									<div class="span6">
										<img alt="Bond Maturity is not available" src="${pageContext.request.contextPath}/visualization/bondmaturitybarchart/450/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span6">
										<img alt="Economic Impact is not available" src="${pageContext.request.contextPath}/visualization/economicimpactcategoryplot/450/400" />
									</div>
									
									<div class="span6">
										<img alt="Principal & Coupon Payments is not available" src="${pageContext.request.contextPath}/visualization/principalcouponpaymentsbarchart/450/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span6">
										<img alt="Nia Loan Collection is not available" src="${pageContext.request.contextPath}/visualization/nialoancollectionbarchart/450/400" />
									</div>
									
									<div class="span6">
										<img alt="Net Lending is not available" src="${pageContext.request.contextPath}/visualization/netlendingbarchart/450/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span10 offset2">
										<img alt="Agri Agra Bonds is not available" src="${pageContext.request.contextPath}/visualization/agriagrabondspiechart/550/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span10 offset2">
										<img alt="Nia Loan Proceeds Allocation is not available" src="${pageContext.request.contextPath}/visualization/loanproceedsallocationpiechart/550/400" />
									</div>
								</div>
								
								<div class="row-fluid">
									<div class="span10 offset2">
										<img alt="Nia Loan Proceeds Utilization is not available" src="${pageContext.request.contextPath}/visualization/loanproceedsutilizationpiechart/550/400" />
									</div>
								</div>
							...
							<div class="tab-pane" id="fadTactical">
								...
								<div class="row-fluid">
									<div class="span6">
										...
										<img alt="Projected Actual Income is not available" src="${pageContext.request.contextPath}/visualization/projectedactualincomechart/450/400" />
										
										<div class="form-inline" style="margin-top:20px;margin-bottom:20px" align = "center">
											<button id="projectedActualIncomeExpenseChart" type="button" class="btn btn-primary">Show Projected Actual Income</button>
										</div>
										
										<img alt="Actual Income Expense is not available" src="${pageContext.request.contextPath}/visualization/actualincomeexpensechart/450/400" /> 
									...
									<div class="span6">
										...
										<img alt="Collection Efficiency is not available" src="${pageContext.request.contextPath}/visualization/collectionefficiencychart/450/400" />
										<br><br><br><br>
